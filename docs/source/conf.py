...
sys.path.insert(0, os.path.abspath("/home/Shared/pingu/sandbox/birdhouse/birdhousebuilder.recipe.sphinx/."))
...
latex_documents = [
  (master_doc, 'project.tex', u'sphinxbuilder Documentation',
   u'Birdhouse', 'manual'),
]
...
man_pages = [
    (master_doc, 'project', u'sphinxbuilder Documentation',
     [author], 1)
]
